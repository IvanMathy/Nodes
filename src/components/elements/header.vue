<template>
  <div class="header">
    <!-- It's 2018, inline SVG logos are okay now right? -->

    <svg class="logo" width="200" height="40">
      <polygon class="logoPath" points="94.4,22.7 83.5,8.8 77.6,8.8 77.6,31.4 83.5,31.4 83.5,17.6 94.4,31.4 100.2,31.4 100.2,8.8
      	94.4,8.8 		"/>
      <path class="logoPath" d="M125.7,11.6c-1.1-1.1-2.4-1.9-4-2.5c-1.5-0.6-3.2-0.9-5-0.9c-1.8,0-3.5,0.3-5.1,0.9c-1.5,0.6-2.8,1.5-3.9,2.5
      ...
      <path class="logoPath" d="M149.5,12.2c-1-1-2.2-1.9-3.5-2.5c-1.4-0.6-2.8-0.9-4.3-0.9H133v22.6h8.7c1.6,0,3-0.3,4.4-0.9
      ...
      <polygon class="logoPath" points="156.5,31.4 169.4,31.4 169.4,26.5 162.4,26.5 162.4,22.6 169,22.6 169,17.6 162.4,17.6 162.4,13.8
      	169.4,13.8 169.4,8.8 156.5,8.8 		"/>
      <path class="logoPath" d="M188,20.2c-0.9-1.1-2.3-1.9-4.2-2.6c-0.5-0.2-1-0.3-1.5-0.5c-0.5-0.1-0.9-0.3-1.3-0.5
      ...
      <path class="logoPath" d="M33.3,31.2c-1.3,0-2.3-1-2.3-2.3s1-2.3,2.3-2.3c0.1,0,0.1,0,0.2,0v-1.3c0-0.8-0.6-1.4-1.4-1.4H18.3
      	c-0.8,0-1.4,0.6-1.4,1.4v8.8c0,0.8,0.6,1.4,1.4,1.4H32c0.8,0,1.4-0.6,1.4-1.4v-3C33.4,31.2,33.3,31.2,33.3,31.2z"/>
      <circle class="logoPath" cx="33.3" cy="28.9" r="1.3"/>

      <circle class="logoPath" cx="47.6" cy="18.6" r="1.3"/>
      <circle class="logoPath" cx="33.3" cy="8.9" r="1.3"/>
      <path class="logoPath" d="M46,16.9c-1.9-0.6-3.2-2.3-4.6-4.1c-1.6-2.1-3.4-4.3-6.2-5.1c0.2,0.4,0.4,0.8,0.4,1.2c0,0.7-0.3,1.3-0.8,1.8
      	c1.7,0.6,2.9,2.2,4.3,3.9c1.7,2.2,3.6,4.6,6.7,5.3c-0.3-0.4-0.4-0.8-0.4-1.3C45.3,17.9,45.6,17.3,46,16.9z"/>
      <path class="logoPath" d="M33.3,11.2c-1.3,0-2.3-1-2.3-2.3s1-2.3,2.3-2.3c0.1,0,0.1,0,0.2,0V5.4C33.4,4.6,32.8,4,32,4H18.3
      	c-0.8,0-1.4,0.6-1.4,1.4v8.7c0,0.8,0.6,1.4,1.4,1.4H32c0.8,0,1.4-0.6,1.4-1.4v-2.9C33.4,11.2,33.3,11.2,33.3,11.2z"/>

      <circle class="logoPath" cx="47.6" cy="24.2" r="1.3"/>
      <path class="logoPath" d="M62.6,13.7H48.8c-0.8,0-1.4,0.6-1.4,1.4v1.2c0.1,0,0.1,0,0.2,0c1.3,0,2.3,1,2.3,2.3s-1,2.3-2.3,2.3
      ...
      <path class="logoPath" d="M45.3,24.2c0-0.5,0.2-1,0.5-1.4c-2.9,0.4-4.7,1.5-6.4,2.6c-1.4,0.9-2.6,1.7-4.4,2c0.3,0.4,0.6,0.9,0.6,1.5
...
/* Old design, please ignore
  -webkit-box-shadow: 0px 1px 0px 0px rgba(98,98,102,.5);
  -moz-box-shadow: 0px 1px 0px 0px rgba(98,98,102,.5);
  box-shadow: 0px 1px 0px 0px rgba(98,98,102,.5);
  */
